...
connector = sqlite3.connect("Expense sharing.db")
...
dataentery_frame_bg = 'palevioletred'
buttons_frame_bg = 'Darksalmon'
hlb_btn_bg = 'paleturquoise'
...
Label(root, text='EXPENSE SHARING APP', font=('verdana', 15, 'bold', 'italic'), bg=hlb_btn_bg).pack(side=TOP, fill=X)
...
dd1 = OptionMenu(data_entry_frame, MoP, *['Cash', 'Cheque', 'Credit Card', 'Debit Card', 'Paytm', 'Google Pay', 'Phone pay'])
